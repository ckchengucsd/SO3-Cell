...
unit_fin = 2
import re as _re
subckt_name     = _re.sub(r'_DH_[NP]$', '', cell_name)
    ...
    with open(cdl_path, 'w', encoding='utf-8') as cf:
        ...
        for t in top_trans:
            ...
            if name in cdl_placement:
                ...
                cf.write(f"{name} {D_orig} {G_orig} {S_orig} {B} pmos_rvt W=46.0n L=16n nfin={nfin}\n")
        for t in bot_trans:
            name, G_orig, D_orig, S_orig, B, nfin = t
            if name in cdl_placement:
                h, c, o, mos_type = cdl_placement[name]
                ...
                cf.write(f"{name} {D_orig} {G_orig} {S_orig} {B} nmos_rvt W=46.0n L=16n nfin={nfin}\n")
        cf.write(".ENDS\n")
